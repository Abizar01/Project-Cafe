...
// fungsi untuk mengambil data detail transaksi berdasarkan id
export const getTransaksiById = async (id) => {
  // url untuk mengambil data menu berdasarkan id
  const URL = `${BASE_API}/transaksi/getById/${id}`;
  // melakukan request ke server
  try {
    // melakukan request ke server
    const data = await axios.get(URL, {
...
// fungsi untuk mengambil data detail transaksi berdasarkan id transaksi
export const getDetailTransaksiByIdTransaksi = async (id) => {
  // url untuk mengambil data menu berdasarkan id transaksi
  const URL = `${BASE_API}/detail_transaksi/getByIdTransaksi/${id}`;
  // melakukan request ke server
  try {
    // melakukan request ke server
    const data = await axios.get(URL, {
